...
class SettingsProvider extends ChangeNotifier {
  ...
  Future<void> _loadSettings() async {
    try {
      ...
      if (themeName == 'White') {
        _themeColor = ThemeColor(name: 'White', color: Colors.white, textColor: Colors.black);
      } else if (themeName == 'Red') {
        _themeColor = ThemeColor(name: 'Red', color: Colors.red, textColor: Colors.white);
      } else if (themeName == 'Orange') {
        _themeColor = ThemeColor(name: 'Orange', color: Colors.orange, textColor: Colors.white);
      } else if (themeName == 'Black') {
        _themeColor = ThemeColor(name: 'Black', color: Colors.black, textColor: Colors.white);
      } else {
        _themeColor = ThemeColor(name: 'Blue', color: const Color(0xFF334970), textColor: Colors.white);
      }
